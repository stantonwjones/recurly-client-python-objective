...
'''A more versatile Object-Oriented Python interface for the Recurly API'''

__original_author__ = 'Drew Yeaton <drew.yeaton@recurly.com>'
__author__ = 'Stanton W. Jones <stanton@recurly.com>'
